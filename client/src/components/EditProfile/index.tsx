...
type MemberToEdit = Pick<MemberFromMemberPov, 'fullname' | 'bio' | 'is_private'>;
...
const EditProfile: React.FC<EditProfileProps> = ({
    ...
    const [memberToEdit, setMemberToEdit] = useState<MemberToEdit>({ ...member });
        ...
        >
            <div className='flex flex-row justify-between items-start'>
                <div className='flex flex-col gap-2'>
                    ...
                    onChange={(e) => setMemberToEdit((prev) => ({ ...prev, fullname: e.target.value }))}
                    type='text' />
                ...
                <div className='flex flex-row gap-2 items-center text-blue-900 fill-current font-semibold'>
                    ...
                    onChange={() => setMemberToEdit((prev) => ({ ...prev, is_private: !prev.is_private }))}
                    type='checkbox' />
                    <Lock />
                </div>
            </div>
            <div className='flex flex-col gap-2 text-normal'>
                ...
                onChange={(e) => setMemberToEdit((prev) => ({ ...prev, bio: e.target.value }))}
                />
            </div>
