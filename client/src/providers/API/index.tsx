    ...
    const Affiliates: API.Context['Actions']['Affiliates'] = {
        Follow(payload) {
            return new Promise((resolve, reject) => {
                ...
                axios.post<APIAction.Affiliates.Follow.Result>(`${API_BASE_PATH}/affiliates/${payload.affiliate_id}/follow`, {}, {
                    headers: { Authorization: `Bearer ${token}` },
                })
                .then((res) => {
                    if (!res.data.done) {
        ...
        Unfollow(payload) {
            return new Promise((resolve, reject) => {
                ...
                axios.delete<APIAction.Affiliates.Unfollow.Result>(`${API_BASE_PATH}/affiliates/${payload.affiliate_id}/unfollow`, {
                    headers: { Authorization: `Bearer ${token}` },
                })
                .then((res) => {
                    if (!res.data.done) {
