...
const AffiliateFollowees: React.FC = () => {
    ...
    const [affiliateFollowees, setAffiliateFollowees] = useState<FollowRequest[]>([]);
    ...
    if (API.Value.fetching || loading)
        return (
            <div className='flex-auto flex flex-col items-center justify-center h-[calc(100vh-2.75rem)] text-2xl'>
                <span className='text-2xl font-bold tracking-wide'>Looking for followees...</span>        
            </div>
        );
    ...
    if (!affiliateFollowees.length)
        return (
            <div className='flex-auto flex flex-col items-center justify-center h-[calc(100vh-2.75rem)] text-2xl'>
                <span className='font-bold tracking-wide'>No followees to show</span>
