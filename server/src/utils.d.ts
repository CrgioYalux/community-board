...
type InsertionQueryActionReturn<T> =
	| { done: true; payload: T }
	| { done: false; message: string };
type SelectQueryActionReturn<T> =
	| { found: true; payload: T }
	| { found: false; message: string };
type DeleteQueryActionReturn =
	| { done: true }
	| { done: false; message: string };
type UpdateQueryActionReturn =
	| { done: true }
	| { done: false; message: string };
...
type MemberIdentificator = Pick<
	Member,
	'entity_id' | 'affiliate_id' | 'member_id'
>;
